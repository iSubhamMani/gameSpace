...
const CartDetails = () => {
  ...
  return cartItems.length === 0 ? (
    <div className="py-6 px-4 bg-bg-secondary-clr-light dark:bg-bg-secondary-clr-dark flex justify-center min-h-[80vh]">
      <p className="text-black dark:text-text-clr-primary font-medium text-lg sm:text-2xl">
        Cart empty...Add some games to your life!
      </p>
    </div>
  ) : (
    <div className="min-h-[80vh] px-4 py-8 bg-bg-secondary-clr-light dark:bg-bg-secondary-clr-dark ">
